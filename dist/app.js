...
const createContainer = (containerName, baseImage) => {
...
const startContainer = (containerName, command) => {
...
const stopContainer = (containerName, pathToContainers) => {
...
const copyFilesIntoContainer = (containerName, sourcePath, destinationPath) => {
...
const copyFilesOutOfContainer = (containerName, sourcePath, destinationPath) => {
...
const setupCgroups = (containerName) => {
...
const setupNetwork = (containerName) => {
...
const createCoWFilesystem = (containerName, baseImage, pathToContainers, pathToBaseImages) => {
...
const createNamespaces = (containerName) => {
...
const chrootToContainer = (containerName, pathToContainers) => {
...
const createDirectory = (containerName, pathToContainers) => {
...
const copyFiles = (sourcePath, destinationPath) => {
...
const setupContainerEnvironment = (containerName) => {
    ...
    // - The example sets up a few environment variables, including 'CONTAINER_NAME', 'DB_HOST', and 'DB_PORT', but you can set any variables relevant to your container.
...
const cleanupContainer = (containerName, pathToContainers) => {
